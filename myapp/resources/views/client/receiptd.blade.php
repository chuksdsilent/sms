    ...
    <div class="d">
                        ...
                        <div class="d-fle">
                            <ul class="">
                                <li> <span>Referred By: </span> <br>
                                    ...
                                    {{\App\Referrals::where("id", $referred_by)->value("name")}}
                                </li>
                            </ul>
        ...
        <div class="controls">
            <a href="#" onclick="window.print()"
                style="background: blue; color:white; margin:.8 em;padding: .5em 1em; border-radius: 2%; text-decoration: none;">Print</a>
