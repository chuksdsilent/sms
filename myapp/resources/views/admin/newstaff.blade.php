...
<div class="custom my-4">
    <div class="card">
        <div class="card-body">
            ...
            <hr />
            <form action="{{url('admin/create-new-staff')}}" method="POST">
                @csrf
                <div class="my-3">
                ...
                <div class="my-3">
                    <label for="" class="form-label">Email</label><input type="text" name="email" class="form-control">
                    @if ($errors->first("email"))
                    <span>{{$errors->first("email")}}</span>
                    @endif
                </div>
                <div class="my-3">
                    <label for="" class="form-label">Phone</label><input type="text" name="phone" class="form-control">
